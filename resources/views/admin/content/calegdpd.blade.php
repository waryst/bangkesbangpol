            ...
            <div class="row mt-2">
                <div class="col-md-12">
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border">DATA CALEG DPD</legend>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-2 text-right">
                                    <input class="form-control form-control-sm form-control-yellow" type="text"
                                        placeholder="Pencarian Caleg..." id="cari_partai">
                                </div>
                            </div>
                        </div>
                        <div class="card">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <label class="mb-0">TAMBAH CALEG DPD</label>
                </div>
...
@push('java')
    ...
    @include('admin.js.dpd.store-caleg')
    @include('admin.js.dpd.update-caleg')
    @include('admin.js.dpd.delete-caleg')
    ...
    <script>
        ...
        function filterRows() {
            ...
            $('#table-body tr').each(function() {
                ...
                // let val2 = $(this).closest('tr').find('.singkat').val().trim().toUpperCase();
                let val3 = $(this).closest('tr').find('.urut').val().trim().toUpperCase();

                if (val1.indexOf(query) !== -1 || val3.indexOf(query) !== -1) {

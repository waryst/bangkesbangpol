...
@section('content')
                                    ...
                                    <tbody id="table-body">
                                        @foreach ($data as $d)
                                            <tr id="{{ $d->id }}">
                                                ...
                                                <td class="td">
                                                    <input type="text" value="{{ $d->nama_cagub }}"
                                                        class="form-control form-control-under border-0 ml-0 nama_cagub"
                                                        name="nama_cagub" autocomplete="off">
                                                </td>
                                                <td class="td">
                                                    <input type="text" value="{{ $d->nama_cawagub }}"
                                                        class="form-control form-control-under border-0 ml-0 nama_cawagub" name="nama_cawagub" autocomplete="off">
                                                </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <label class="mb-0">TAMBAH PASANGAN CALON GUBERNUR</label>
                </div>
                <div class="modal-body">
                    <form id="new" enctype="multipart/form-data">
                        ...
                        <div class="form-group floating">
                            <input type="text" class="form-control floating" id="nama_cagub" name="nama_cagub" autocomplete="off">
                            <label for="nama_cagub">Nama calon gubernur</label>
                        </div>

                        <div class="form-group floating">
                            <input type="text" class="form-control floating" id="nama_cawagub" name="nama_cawagub" autocomplete="off">
                            <label for="nama_cawagub">Nama calon wakil gubernur</label>
                        </div>
                        ...
                        <div class="form-group floating">
                            ...
                            <label for="foto">Foto pasangan cagub </label>
                        </div>
    ...
    <div class="modal fade" id="modal-foto">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <label class="mb-0">UPLOAD FOTO PASANGAN CALON GUBERNUR</label>
                </div>
                <div class="modal-body">
                    <form id="edit" enctype="multipart/form-data">
                        <div class="form-group floating">
                            ...
                            <input type="file" name="foto" class="form-control floating" id="customFile" accept="image/png, image/jpeg"
                                style="padding-top:10px;padding-bottom:34px;">
                            <label for="customFile">Foto pasangan cagub </label>
                        </div>
...
@push('java')
    ...
    @include('admin.js.cagub.store-cagub')
    @include('admin.js.cagub.update-cagub')
    @include('admin.js.cagub.update-foto-cagub')
    @include('admin.js.cagub.delete-cagub')
    <script>
        $("#table-body").on("click", ".img-eye", function(e) {
            ...
            Swal.fire({
                imageUrl: 'foto/' + img,
                imageAlt: 'Cagub No. ' + no,
                text: 'Cagub Nomor Urut ' + no,
    ...
    <script>
        ...
        function filterRows() {
            ...
            $('#table-body tr').each(function() {
                let val1 = $(this).closest('tr').find('.nama_cagub').val().trim().toUpperCase();
                let val2 = $(this).closest('tr').find('.nama_cawagub').val().trim().toUpperCase();

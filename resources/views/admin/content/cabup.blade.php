...
@section('content')
                                    ...
                                    <tbody id="table-body">
                                        @foreach ($data as $d)
                                            <tr id="{{ $d->id }}">
                                                ...
                                                <td class="td">
                                                    <input type="text" value="{{ $d->nama_cabub }}"
                                                        class="form-control form-control-under border-0 ml-0 nama_cabub"
                                                        name="nama_cabub" autocomplete="off">
                                                </td>
                                                <td class="td">
                                                    <input type="text" value="{{ $d->nama_cawabub }}"
                                                        class="form-control form-control-under border-0 ml-0 nama_cawabub" name="nama_cawabub" autocomplete="off">
                                                </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <label class="mb-0">TAMBAH PASANGAN CALON BUPATI</label>
                </div>
                <div class="modal-body">
                    <form id="new" enctype="multipart/form-data">
                        ...
                        <div class="form-group floating">
                            <input type="text" class="form-control floating" id="nama_cabub" name="nama_cabub" autocomplete="off">
                            <label for="nama_cabub">Nama calon bupati</label>
                        </div>

                        <div class="form-group floating">
                            <input type="text" class="form-control floating" id="nama_cawabub" name="nama_cawabub" autocomplete="off">
                            <label for="nama_cawabub">Nama calon wakil bupati</label>
                        </div>
                        ...
                        <div class="form-group floating">
                            ...
                            <label for="foto">Foto pasangan cabup </label>
                        </div>
    ...
    <div class="modal fade" id="modal-foto">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <label class="mb-0">UPLOAD FOTO PASANGAN CALON BUPATI</label>
                </div>
                <div class="modal-body">
                    <form id="edit" enctype="multipart/form-data">
                        <div class="form-group floating">
                            ...
                            <input type="file" name="foto" class="form-control floating" id="customFile" accept="image/png, image/jpeg"
                                style="padding-top:10px;padding-bottom:34px;">
                            <label for="customFile">Foto pasangan cabup </label>
                        </div>
...
@push('java')
    ...
    @include('admin.js.cabup.store-cabup')
    @include('admin.js.cabup.update-cabup')
    @include('admin.js.cabup.update-foto-cabup')
    @include('admin.js.cabup.delete-cabup')
    <script>
        $("#table-body").on("click", ".img-eye", function(e) {
            ...
            Swal.fire({
                imageUrl: 'foto/' + img,
                imageAlt: 'Cabup No. ' + no,
                text: 'Cabup Nomor Urut ' + no,
    ...
    <script>
        ...
        function filterRows() {
            ...
            $('#table-body tr').each(function() {
                let val1 = $(this).closest('tr').find('.nama_cabub').val().trim().toUpperCase();
                let val2 = $(this).closest('tr').find('.nama_cawabub').val().trim().toUpperCase();

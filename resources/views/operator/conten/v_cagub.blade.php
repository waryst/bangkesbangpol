                                    ...
                                    <div class="d-flex justify-content-center align-items-center">
                                        @if ($pilih_tps->id ?? 0 != null)
                                            <div style="position: relative">
                                                <input type="number" min="0" id="{{ $cagub->id }}"
        ...
        $(document).ready(function() {
            ...
            $('.submittidaksah').blur(function() {
                ...
                if (jumlah_suara != $("#" + input_id).attr("data-default")) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ url('savesuara/suaratidaksahgubernur') }}",
                        data: fd,
                        contentType: false,
                        processData: false,
                        dataType: 'json',
                ...
                if (jumlah_suara != $("#" + input_id).attr("data-default")) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            `);
                            document.getElementById(data.cagub_id).setAttribute("data-default",
                                data.jumlah_suara);
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#save' + data.cagub_id).html(`
                        ...
                        `);
                    document.getElementById(data.cagub_id).setAttribute("data-default", data.jumlah_suara);
                },
                error: function(data) {
                    var errors = data.responseJSON;
                    if ($.isEmptyObject(errors) == false) {

                    ...
                    @foreach ($cabub as $cabub)
                        <div class="col-md-4">
                            <div class="card card_suara">
                                ...
                                <img src="{{ asset('foto/' . $cabub->foto . '.jpeg') }}" class="card-img-top "
                                    alt="...">
                                        ...
                                        @if ($pilih_tps->id ?? 0 != null)
                                            <div style="position: relative">
                                                <input type="number" min="0"
                                                    ...
                                                    id="{{ $cabub->id }}" data-id="{{ $cabub->id }}"
                                                    onfocus="this.placeholder = ''" onblur="this.placeholder = '0'"
                                                    value="{{ $cabub->suaracabub->where('tps_id', $pilih_tps->id)->first()->jumlah ?? 0 }}"
                                                ...
                                                <div class="loadingsuara" id="save{{ $cabub->id }}"
                                                    ...
                                                    <svg viewBox="0 0 128 128" width="30" height="30">
                                                        @if ($cabub->suaracabub->where('tps_id', $pilih_tps->id)->first()->jumlah ?? 0 != null)
                                                            <path

    ...
    <section class="content">
        <div class="container-fluid">
            <fieldset class="scheduler-border">
                <legend class="scheduler-border">Perolehan Suara Sah Calon Presiden dan Wakil Presiden
                </legend>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    @foreach ($capres as $capres)
                        <div class="col-md-4">
                            <div class="card card_suara">
                                ...
                                <img src="{{ asset('foto/' . $capres->foto) }}" class="card-img-top " alt="...">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center">
                                        ...
                                        @if ($pilih_tps->id ?? 0 != null)
                                            <div style="position: relative">
                                                <input type="number" min="0" id="{{ $capres->id }}"
                                                    data-default="{{ $capres->suaracapres[0]->jumlah ?? 0 }}"
                                                    onKeyPress="if(this.value.length==3) return false;"
                                                    oninput="this.value = Math.abs(this.value)" autocomplete="off"
                                                    onfocus="this.placeholder = ''" onblur="this.placeholder = '0'"
                ...
                if (jumlah_suara != $("#" + input_id).attr("data-default")) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            `);
                            document.getElementById(data.capres_id).setAttribute(
                                "data-default", data.jumlah_suara);
        ...
        function saveSuara() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    `);
                    document.getElementById(data.capres_id).setAttribute("data-default", data.jumlah_suara);
                },
                error: function(data) {
                    var errors = data.responseJSON;
                    if ($.isEmptyObject(errors) == false) {
